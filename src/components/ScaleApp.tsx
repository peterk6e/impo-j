...
function ScaleSelector({ keyNote, scale, setKey, setScale }: {
  keyNote: string
  scale: string
  ...
  export function ScaleSummary({ scaleData }: { scaleData: any }) {
    ...
    return (
      <div className="space-y-6">
        ...
        {/* Scale Degrees */}
        <details open>
          <summary className="cursor-pointer text-lg font-semibold mb-3 select-none">Scale Degrees & Chords</summary>
              ...
              return (
                ...
                >
                  ...
                  <div className="text-xs text-gray-500">
                    ...
                    extensions: {deg.extensions.map((ext:any, idx:any) => (
                        <span
                        key={idx}
                        className='text-jazz-500'
                        >
                        {ext}
