...
export function useProfile(
  userId: string,
  options?: { initialData?: Profile | null; enabled?: boolean },
) {
  return useQuery({
...
export function useCreateProfile() {
  ...
  return useMutation({
    ...
    onSuccess: (data, variables) => {
      ...
      logger.info('Profile created and cache updated', {
...
export function useUpdateProfile() {
  ...
  return useMutation({
    ...
    onSuccess: (data, variables) => {
      ...
      logger.info('Profile updated and cache updated', {
        userId: variables.userId,
      });
    },
    onError: (error, variables) => {
